...
<template>
    <transition name="fade-scale" mode="out-in">
        <main v-show="isOpen"
            class="z-20 h-full w-full bg-[#181818E5] backdrop-blur-[0.3125rem] absolute top-0 left-0 flex items-center justify-center">
            <div class="bg-white rounded-lg p-8 flex items-center justify-center flex-col">
                ...
                <div class="flex flex-col items-center justify-center">
                    ...
                    <h3 class="text-purple-900 text-2xl font-medium mt-3">Nome do projeto</h3>
